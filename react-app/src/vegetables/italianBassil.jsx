...
export default function ItalianBassil() {
  // State to hold broccoli data
  const [italianBassil, setItalianBassil] = useState([]);

  useEffect(() => {
    // Function to fetch broccoli data
    const fetchItalianBassil = async () => {
      try {
        // Fetch data from server
        const response = await axios.get(
          "http://localhost:4000/api/italianBassil"
        );
        ...
        setItalianBassil(response.data);
      } catch (error) {
      ...
      <div className="page-header d-print-none">
        <div className="container">
          <div className="row g-3 align-items-center">
            ...
            <div className="col">
              <h2 className="page-title">italianBassil</h2>
              <div className="text-secondary">
                <ul className="list-inline list-inline-dots mb-0">
                  <li className="list-inline-item"></li>
                  <li className="list-inline-item">italianBassil</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="card card-sm">
              <div className="card-body">
                <div className="row align-items-center">
                  ...
                  <div className="col">
                    <div className="font-weight-medium">₹47.00 Week Lowest</div>
                    <div className="text-secondary">(Wholesale)</div>
                  </div>
                </div>
              </div>
